...
| `dashboards/instruqt-metric-governance-dashboard.json` | **Instruqt** push target: **`markdown`** + **`vis`** panels (`config.type` **metric** / **gauge** / **xy**) for `POST /api/dashboards` **2023-10-31**. |
