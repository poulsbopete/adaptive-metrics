...
| `dashboards/instruqt-metric-governance-dashboard.json` | **Instruqt** push: **`markdown`** + **`vis`** where **`config.type` is `data_table`** and **`data_source.type` is `esql`** (required for **Elastic-Api-Version: 2023-10-31**). |
